...
export default function Sidebar() {
  return (
    <div className='flex flex-col bg-background text-primaryText xl:w-[320px] lg:w-[260px] md:w-[200px] w-[180px] border-r border-zinc-800 text-secondaryText'>
      <div className='flex border-b border-zinc-800 p-2 xl:p-7 l:p-5 md:p-3 justify-center xl:h-[96px] l:h-[80px] md:h-[64px] h-[48px] cursor-pointer'><img src='/icons/logo.svg'/></div>
      <div className='flex items-center gap-2 p-6 pl-8 cursor-pointer'>
        ...
        <div className='text-[10px] md:text-[12px] lg:text-[14px] xl:text-[16px] '>Dashboard</div>
      </div>
      <div className='flex items-center gap-2 p-6 pl-8 cursor-pointer'>
