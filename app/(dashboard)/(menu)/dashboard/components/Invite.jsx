...
export default function Invite({ referral, users, successfulInvites }) {
  ...
  return (
    <div className='text-secondaryText pb-20'>
      <div className='flex max-lg:flex-col border-b border-zinc-800 justify-between'>
        <div className='flex flex-col gap-6 p-2 md:p-4 lg:p-8 xl:p-12 text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]'>
          <div>
          ...
          <div className='flex gap-2 lg:gap-4 xl:gap-8 '>
            ...
            >
              <Image
                className=' h-[40px] w-[40px] xl:h-[48px] md:w-[48px]'
                height={48}
                width={48}
        ...
        <div>
          <div className='flex flex-col gap-8 p-2 md:p-4 lg:p-8 xl:p-12 text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]'>
            ...
            <div className='flex flex-col gap-2'>
              <div className='flex items-center justify-between p-4 gradientbg border border-zinc-800 h-[56px] w-full lg:h-[72px] lg:w-[580px] xl:h-[80px] xl:w-[640px]'>
