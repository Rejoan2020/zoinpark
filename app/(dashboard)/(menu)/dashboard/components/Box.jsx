...
export default function Box({ url, title, amount, challenge }) {
  ...
  return (
    <div className='flex items-center justify-between pl-4 pr-4 w-full max-w-[716px] lg:w-[650px] h-[50px] md:h-[60px] lg:h-[70px] xl:h-[80px] border rounded-md border-zinc-800 gradientbg'>
