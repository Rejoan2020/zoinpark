...
export default function Card() {
  return (
    <div className='flex flex-col gap-2 md:gap-3 lg:gap-4 xl:gap-5 border border-zinc-800 p-4 md:p-5 lg:p-6 xl:p-8 bg-[#0C1110] h-[204px] w-[191px] md:h-[274px] md:w-[291px] lg:h-[374px] lg:w-[391px] xl:h-[400px] xl:w-[491px]'>
      <div>
        <div className='text-[18px] md:text-[24px] lg:text-[30px] xl:text-[36px]'>Silver</div>
        <div className='text-secondaryText text-[8px] md:text-[10px] lg:text-[14px] xl:text-[18px]'>1 ZOIN TO 3000 ZOIN</div>
      </div>
      ...
      <div>
        <div className='flex'>
          ...
          <div className='text-[8px] md:text-[10px] lg:text-[14px] xl:text-[18px]'>Daily profit: 0.15%</div>
        </div>
        <div className='flex'>
          <Image className='h-3 w-3 md:h-4 md:w-4 lg:h-5 lg:w-5 xl:h-6 xl:w-6' height={24} width={24} alt='right' src={'/icons/right.svg'} />
          <div className='text-[8px] md:text-[10px] lg:text-[14px] xl:text-[18px]'>7 days/week</div>
        </div>
      </div>
