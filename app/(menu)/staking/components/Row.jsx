...
export default function Row({serial, id, name, principal, withdrawal, balance, start, payment, action}) {
  return (
    <div className={`grid grid-cols-9 items-center text-[8px] md:text-[10px] lg:text-[14px] xl:text-[18px] pl-2 pr-2 xl:pl-4 xl:pr-4 border border-zinc-800 ${serial===10?"rounded-b-md":""}`}>
          ...
          <div className='p-4 flex justify-center '>{payment}</div>
